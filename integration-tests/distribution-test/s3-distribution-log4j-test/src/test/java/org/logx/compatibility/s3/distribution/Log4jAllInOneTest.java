 ...
 */
@SpringBootTest
public class Log4jAllInOneTest {

    private static final Logger logger = LoggerFactory.getLogger(Log4jAllInOneTest.class);

    @Test
    public void testOSSConnectionAndLogging() throws Exception {
        logger.info("开始Log4j All-in-One JAR兼容性测试...");
        ...
        logger.info("Log4j All-in-One JAR兼容性测试完成！");
    ...
    public void testPerformanceStressLogsGeneration() throws Exception {
        logger.info("🚀 开始Log4j All-in-One性能压力测试");
