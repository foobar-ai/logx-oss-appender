package org.logx.compatibility.s3.distribution;
 ...
 */
@SpringBootTest
public class LogbackAllInOneTest {

    private static final Logger logger = LoggerFactory.getLogger(LogbackAllInOneTest.class);

    @Test
    public void testOSSConnectionAndLogging() throws Exception {
        logger.info("开始Logback All-in-One JAR兼容性测试...");
        ...
        logger.info("Logback All-in-One JAR兼容性测试完成！");
    ...
    public void testPerformanceStressLogsGeneration() throws Exception {
        logger.info("🚀 开始Logback All-in-One性能压力测试");
